        ...
        <div class="max-w-5xl mx-auto text-center">
            ...
            <div class="max-w-5xl mx-auto rounded-3xl border border-gray-700/80 bg-gray-800/80 backdrop-blur p-4 md:p-5 shadow-2xl">
                <form action="{{ route('flights.search') }}" method="GET">
                    <div class="grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr_auto] gap-4 items-stretch md:items-end">
                        <div class="text-left">
                        ...
                        <div class="flex items-end">
                            <button
                                type="submit"
                                title="Buscar vuelos"
                                class="w-full md:w-[54px] h-[54px] rounded-2xl bg-blue-600 hover:bg-blue-700 text-white transition flex items-center justify-center shadow-lg shadow-blue-900/30 hover:scale-[1.03]"
                            >
            ...
            @if(count($flights) > 0)
                ...
                <div class="space-y-4">
                    @foreach($flights as $vuelo)
                        <div class="bg-gray-800 border border-gray-700 hover:border-blue-500 rounded-2xl p-4 sm:p-6 transition">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div class="flex items-center justify-between gap-3 sm:gap-6 overflow-x-auto md:overflow-visible pb-2 md:pb-0">
                                ...
                                <div class="flex flex-col items-stretch md:items-end gap-3">
                                    ...
                                    <a href="{{ route('reserves.create', $vuelo->id_flights) }}"
                                       class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2.5 rounded-lg transition text-sm whitespace-nowrap text-center">
                                        Seleccionar Asiento
                                    </a>
                                </div>
                            </div>
